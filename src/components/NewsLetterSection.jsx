...
const NewsLetterSection = () => {
  return (
    ...
    <section className=' max-w-5xl container mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-12' >
      <div className='relative bg-blue-600 rounded-2xl py-16 overflow-hidden'>
        ...
        <div className='flex flex-col md:flex-row justify-between px-8'>
          ...
          {/* right */}
          <form action="" className="z-15 flex py-2"> 
            <input type="text" placeholder="Email Address" 
            className="bg-white px-6  rounded-l-lg"/>
            <button className="flex items-center justify-center gap-1 bg-green-500 px-4 rounded-r-lg text-white cursor-pointer">
              <span>Discover</span>
